...
public class ShardOverlay extends Overlay {
    ...
    private static final Identifier SHARD_BASE_OVERLAY = new Identifier("gnomesandtomes", "textures/gui/shard_0.png");
    private static final Identifier SHARD_RIGHT_CLICK = new Identifier("gnomesandtomes", "textures/gui/shard_right.png");
    private static final Identifier SHARD_LEFT_CLICK = new Identifier("gnomesandtomes", "textures/gui/shard_left.png");
