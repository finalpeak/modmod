...
public class BoulderAnimations {
	public static final Animation EARTHQUAKE = Animation.Builder.create(5.0F)
		.addBoneAnimation("boulder", new Transformation(Transformation.Targets.ROTATE, 
			...
			new Keyframe(3.375F, AnimationHelper.createRotationalVector(-15.0F, 0.0F, 2.5F), Transformation.Interpolations.LINEAR),
			new Keyframe(3.5F, AnimationHelper.createRotationalVector(-15.0F, 0.0F, -2.5F), Transformation.Interpolations.LINEAR),
			new Keyframe(3.625F, AnimationHelper.createRotationalVector(-15.0F, 0.0F, 2.5F), Transformation.Interpolations.LINEAR),
			new Keyframe(3.75F, AnimationHelper.createRotationalVector(-15.0F, 0.0F, -2.5F), Transformation.Interpolations.LINEAR)
		))
